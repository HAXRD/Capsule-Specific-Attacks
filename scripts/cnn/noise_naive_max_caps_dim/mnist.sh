...
# debug
# python ~/DeepDream/experiment.py --total_batch_size=1 --mode=noise_naive_max_caps_dim --data_dir=/home/xuc/DeepDream/data/mnist/ --dataset=mnist --max_epochs=5 --iter_n=100 --summary_dir=/home/xuc/projects/def-sageev/xuc/debug/cnn/mnist --model=cnn
