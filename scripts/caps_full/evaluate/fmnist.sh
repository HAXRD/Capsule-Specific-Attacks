...
python ~/DeepDream/experiment.py --total_batch_size=200 --mode=evaluate --data_dir=/home/xuc/DeepDream/data/fashion_mnist/ --dataset=fashion_mnist --max_epochs=1 --summary_dir=/home/xuc/projects/def-sageev/xuc/final/caps_full/fmnist 
