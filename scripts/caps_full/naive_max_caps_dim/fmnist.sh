...
python ~/DeepDream/experiment.py --total_batch_size=1 --mode=naive_max_caps_dim --data_dir=/home/xuc/DeepDream/data/fashion_mnist/ --dataset=fashion_mnist --max_epochs=5 --iter_n=1000 --summary_dir=/home/xuc/projects/def-sageev/xuc/final/caps_full/fmnist --step=0.1
