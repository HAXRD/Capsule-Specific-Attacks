...
python ~/DeepDream/experiment.py --total_batch_size=1 --mode=max_norm_diff --data_dir=/home/xuc/DeepDream/data/mnist/ --dataset=mnist --max_epochs=10 --iter_n=1000 --summary_dir=/home/xuc/projects/def-sageev/xuc/final/cnn/mnist --model=cnn --step=0.1 --image_size=24
