...
python ~/DeepDream/experiment.py --total_batch_size=1 --mode=max_caps_dim_diff --data_dir=/home/xuc/DeepDream/data/svhn/ --dataset=svhn --max_epochs=5 --iter_n=1000 --summary_dir=/home/xuc/projects/def-sageev/xuc/final/caps_full/svhn --step=0.1 --image_size=24
