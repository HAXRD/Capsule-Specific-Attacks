...
python ~/DeepDream/experiment.py --total_batch_size=1 --mode=noise_max_caps_dim_diff --data_dir=/home/xuc/DeepDream/data/mnist/ --dataset=mnist --max_epochs=5 --iter_n=1000 --summary_dir=/home/xuc/projects/def-sageev/xuc/final/caps_full/mnist --step=0.1 --image_size=24
